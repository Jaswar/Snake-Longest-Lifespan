...
filepathToSave = 'modelAliveTime.h5'
...
#            model.save(filepathToSave)
    ...
    print('Epoch: ' + str(epoch) + ' Total iterations: ' + str(iteration) + ' Epsilon: {:.5f}'.format(epsilon))
